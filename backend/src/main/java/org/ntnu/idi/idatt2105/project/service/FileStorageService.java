...
public class FileStorageService {
    ...
    /**
     * Store a file. The file is stored in the directory specified in the application.properties file.
    ...
    /**
     * Load a file from the file storage location. If the file does not exist, a default image is returned.
