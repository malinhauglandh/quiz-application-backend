...
public class QuizController {
    ...
    @Operation(summary = "Upload a multimedia-file to a quiz",
        parameters = {
            @Parameter(name = "file", description = "The multimedia-file to upload"),
            @Parameter(name = "quizId", description = "The id of the quiz to link the multimedia-file to")
        },
        responses = {
            @ApiResponse(responseCode = "200", description = "Multimedia-file uploaded successfully"),
    ...
    @Operation(summary = "Get a multimedia-file by filename",
        parameters = {
    ...
    @Operation(summary = "Get a quiz by creatorId",
        parameters = {
