...
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES (" 2 * 3 = _ ?", 3, 1);

-- Science Quiz Questions
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("The man _ invented the light bulb?", 3, 2);
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("There are 206 bones in the human body?", 2, 2);
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("How many colors are in the rainbow?", 1, 2);
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("True or false, the tallest grass on earth is bamboo?", 2, 2);
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("What is the largest desert in the world?", 1, 2);
...
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("True or False, World War II started in 1940?", 2, 3);
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("Who was the first computer programmer?", 1, 3);
...
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("What is not an ingredient in a cake?", 1, 4);
INSERT INTO question (question_text, question_type_id, quiz_id) VALUES ("What is a group of crows called?", 1, 4);
...
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("5", "wrong answer", false, 5);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("7", "wrong answer", false, 5);
...
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Albert Einstein", "Albert Einstein did not invent the light bulb", false, 6);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Thomas Jefferson", "Thomas Jefferson did not invent the light bulb", true, 7);
...
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("7", "There are 7 colors in the rainbow", true, 8);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("6", "This is wrong!", false, 8);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("8", "This is wrong!", false, 8);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("9", "This is wrong!", false, 8);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("true", "Bamboo is the tallest grass on earth", true, 9);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("false", "This is wrong!", false, 9);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Sahara", "It’s not the Sahara, but actually Antarctica!", false, 10);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Antarctica", "Correct", true, 10);

-- History Quiz Choices
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Paris", "Paris is the capital of France", true, 9);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("London", "London is not the capital of France", false, 9);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Oslo", "Oslo is the capital of Norway", true, 10);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Stockholm", "Stockholm is not the capital of Norway", false, 10);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("false", "World War II started in 1939", false, 11);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("true", "World War II started in 1939", true, 11);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Ada Lovelace", "Ada Lovelace was the first computer programmer, she created a program for an Analytical Engine", true, 12);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Alan Turing", "Alan Turing was not the first computer programmer", false, 12);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Linus Torvalds", "Linus Torvalds was not the first computer programmer", false, 12);

-- Random Quiz Choices
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("true", "The Earth is round", false, 13);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("false", "The Earth is round", true, 13);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("true", "This is actually true, even bigger than dinosaurs", true, 14);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("false", "They are the biggest animals to have ever lived", false, 14);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Flour", "Flour is an ingredient in a cake", false, 15);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Sugar", "Sugar is an ingredient in a cake", false, 15);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("Sement", "Sement is not an ingredient in a cake", true, 15);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("A killer", "This is not correct", false, 16);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("A murder", "Correct! Scary right?", true, 16);
INSERT INTO question_choices (choice_text, explanation, is_correct, question_id) VALUES ("A pack", "Wrong answer!", false, 16);
