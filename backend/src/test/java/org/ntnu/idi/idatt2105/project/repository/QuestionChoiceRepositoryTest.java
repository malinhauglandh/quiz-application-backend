...
public class QuestionChoiceRepositoryTest {
    ...
    @Autowired private QuestionChoiceRepository questionChoiceRepository;
    @Autowired private QuestionRepository questionRepository;
    @Autowired private QuizRepository quizRepository;
    @Autowired private QuestionTypeRepository questionTypeRepository;
    ...
    void verifyFindAllQuestionChoicesByQuestionId() {
        ...
        assertThat(choices.get(0).getQuestion().getQuestionId())
                .isEqualTo(savedQuestion.getQuestionId());
    }
    ...
    void verifySaveAndFindChoiceById() {
        ...
        Optional<QuestionChoice> foundChoice =
                questionChoiceRepository.findById(savedChoice.getQuizChoiceId());
